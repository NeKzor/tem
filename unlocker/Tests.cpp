...
{
    {
        BYTE unlock_code_hex_buffer[41] = { 0x1A, 0x09, 0x07, 0x14, 0x1A, 0x1F, 0x1A, 0x01, 0x12, 0x0D, 0x04, 0x17,
            0x03, 0x1F, 0x16, 0x12, 0x15, 0x1E, 0x0C, 0x03, 0x06, 0x0A, 0x01, 0x1A, 0x0F, 0x17, 0x0E, 0x17, 0x01, 0x15,
            0x0F, 0x1D, 0x03, 0x14, 0x15, 0x15, 0x04, 0x0E, 0x0F, 0x16 };
        ...
        auto output_buffer_hex = to_hex(output_buffer);
        // clang-format off
        EXPECT_EQ(output_buffer_hex, "5542394E555A55334C463652355A514C50594535384333554852475233504858354E505036474851320000000000000000000000000000000000000000000000");
        // clang-format on
    }

    {
        BYTE unlock_code_hex_buffer[41] = { 0x15, 0x11, 0x1F, 0x08, 0x07, 0x0E, 0x1A, 0x1B, 0x12, 0x14, 0x07, 0x08,
            0x19, 0x13, 0x17, 0x1E, 0x0E, 0x12, 0x07, 0x0E, 0x0C, 0x1B, 0x19, 0x0E, 0x05, 0x0D, 0x0A, 0x00, 0x15, 0x0F,
            0x1A, 0x0B, 0x0B, 0x02, 0x01, 0x11, 0x07, 0x0E, 0x04, 0x07 };
        BYTE output_buffer[64] = {};
        ...
        auto output_buffer_hex = to_hex(output_buffer);
        // clang-format off
        EXPECT_EQ(output_buffer_hex, "504B5A41394755564C4E3941544D5259474C39474556544737464332504855444434334B39473639320000000000000000000000000000000000000000000000");
        // clang-format on
    }
}
